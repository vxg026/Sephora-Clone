...
from wtforms import TextAreaField, IntegerField, StringField, MultipleFileField
...
class ReviewForm(FlaskForm):
    ...
    images = MultipleFileField("Images", validators=[FileAllowed(list(ALLOWED_EXTENSIONS))])
